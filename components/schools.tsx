...
export default function Schools() {
  ...
  return (
    <section className="w-full flex flex-col items-start justify-center">
      <h1 className="text-[15px] font-semibold mb-4">Manage Schools</h1>
            ...
            <TableBody>
              {schools.map((school) => (
                ...
                >
                  ...
                  <TableCell>
                    <span
                      className={`text-xs text-white px-2 py-1 rounded ${school.is_active === true ? "bg-green-500" : "bg-red-500"}`}
                    >
